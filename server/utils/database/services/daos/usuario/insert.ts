...
import type { ViewUserAdmin } from '../../types/views/UserAdmin';
import type { ViewUserApSOffice } from '../../types/views/UserApSOffice';
import type { ViewUserCommunityPartner } from '../../types/views/UserCommunityPartner';
import type { ViewUserExternalProfessor } from '../../types/views/UserExternalProfessor';
import type { ViewUserExternalStudent } from '../../types/views/UserExternalStudent';
import type { ViewUserInternalProfessor } from '../../types/views/UserInternalProfessor';
import type { ViewUserInternalStudent } from '../../types/views/UserInternalStudent';
